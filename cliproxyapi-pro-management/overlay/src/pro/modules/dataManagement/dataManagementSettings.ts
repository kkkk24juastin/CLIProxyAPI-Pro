...
export type DataManagementSettingsDraft = {
...
export const createDataManagementSettingsDraft = (
...
export const buildDataManagementSettingsFromDraft = (
  draft: DataManagementSettingsDraft
