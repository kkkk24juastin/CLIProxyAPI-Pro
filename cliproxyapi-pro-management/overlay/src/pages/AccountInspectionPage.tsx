...
import { accountInspectionApi, apiClient, type AccountInspectionLogStreamMessage, type AccountInspectionScheduleResponse } from '@/services/api';
...
const buildAccountInspectionLogsWebSocketUrl = (apiBase: string) => {
...
const accountInspectionWebSocketProtocol = (managementKey: string) =>
