...
def patch_quota_page(target: Path) -> None:
    ...
    replace_all(
        path,
        "import { FEATURES, quotaPersistenceMiddleware } from '@/pro/modules/quota';\n",
        "",
    )
    insert_once(
        path,
...
def patch_quota_page_search(target: Path) -> None:
    ...
    insert_once(
        ...
        "import { GEMINI_CLI_CONFIG } from '@/pro/modules/quota';\n",
        "import { GEMINI_CLI_CONFIG } from '@/pro/modules/quota';\n"
        "import { resolveXaiPlanType } from '@/pro/modules/quota';\n",
        "resolveXaiPlanType",
    )
    insert_once(
        page_path,
...
def patch_auth_files_gemini_quota(target: Path) -> None:
    ...
    insert_once(
        ...
        "} from '@/components/quota';\n"
        "import { GEMINI_CLI_CONFIG } from '@/pro/modules/quota';\n",
        "GEMINI_CLI_CONFIG } from '@/pro/modules/quota'",
    )
    replace_once(
        quota_section_path,
